...
const (
	typeGenericThresh  = 16
	typeStandardThresh = 1024

	// TypeDriverThresh is the minimum value for driver defined types.
	TypeDriverThresh = 0x00010000
)

// Type represents a data type in the database.
...
// Driver returns true if this is a driver defined type.
...
func (t Type) Generic() bool {
	return t >= typeGenericThresh && t < typeStandardThresh
}

// Unknown type, driver should guess. Not all drivers may supprt guessing.
const (
	TypeUnknown Type = 0
)
...
const (
	Text Type = typeGenericThresh + iota
	Binary
	Bool
	Integer
	Float
...
const (
	...
	TypeText        Type = typeStandardThresh + iota // Unicode text with varying length. Also nvarchar.
